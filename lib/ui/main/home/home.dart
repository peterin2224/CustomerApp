...
class HomeScreen extends StatefulWidget {
  ...
  final scaffoldKey;
  HomeScreen({required this.redraw, required this.onErrorDialogOpen, required this.callback, this.scaffoldKey});
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _children(){
    ...
    for (var row in appSettings.rows){
      ...
      //
      if (row == "banner1"){
        if (homeScreen.secondStepData != null && homeScreen.secondStepData!.banner1.isNotEmpty) {
          list.add(Container(
      ...
      //
      if (row == "banner2"){
        if (homeScreen.secondStepData != null && homeScreen.secondStepData!.banner2.isNotEmpty) {
          list.add(Container(
