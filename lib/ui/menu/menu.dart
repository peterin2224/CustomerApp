...
class Menu extends StatelessWidget {
  ...
  Menu({required this.context, required this.callback});
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              if (appSettings.about == "true")
                skinMenuItem(20, appSettings.aboutTextName, context, _onMenuClickItem),
              if (appSettings.delivery == "true")
                skinMenuItem(21, appSettings.deliveryTextName, context, _onMenuClickItem),
              if (appSettings.privacy == "true")
                skinMenuItem(22, appSettings.privacyTextName, context, _onMenuClickItem),
              if (appSettings.terms == "true")
                skinMenuItem(23, appSettings.termsTextName, context, _onMenuClickItem),
              if (appSettings.refund == "true")
                skinMenuItem(24, appSettings.refundTextName, context, _onMenuClickItem),
