...
class PayUPayment extends StatefulWidget {
  ...
  PayUPayment({required this.onFinish, required this.userName, required this.email,
    required this.phone, required this.payAmount, required this.apiKey, required this.token,
