...
class Response {
  ...
  Response({required this.error, required this.address});
...
class AddressData {
  ...
  AddressData({required this.id, required this.updatedAt, required this.text,
    required this.lat, required this.lng, required this.type,
    required this.defaultAddress, this.selected = false});
