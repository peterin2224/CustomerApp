...
class SecondStepData {
  ...
  SecondStepData({required this.error, required this.banner1, required this.foods, required this.banner2, });
...
class BannerData {
  ...
  String details;
  String position;
  BannerData({required this.id, required this.image, required this.type, required this.details, required this.position});
