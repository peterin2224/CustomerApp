...
class ResponseRestaurant {
  ...
  ResponseRestaurant({required this.error, required this.foods, required this.currency,
    required this.restaurant, required this.categories, required this.restaurantsreviews,
    required this.banner1, required this.ver});
