...
class Response {
  ...
  int unread;
  Response({required this.error, required this.users, required this.unread});
...
class ChatUsers {
  ...
  ChatUsers({required this.id, required this.name, required this.image, required this.count, required this.unread, required this.text});
