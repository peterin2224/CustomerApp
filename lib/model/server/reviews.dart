...
class Response {
  ...
  Response({required this.error, required this.date, required this.reviews});
...
class ResponseR {
  ...
  ResponseR({required this.error, required this.date, required this.reviews});
  factory ResponseR.fromJson(Map<String, dynamic> json){
    List<RestaurantsReviewsData> n = [];
    if (json['reviews'] != null) {
      var items = json['reviews'];
