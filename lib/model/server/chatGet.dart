...
class ResponseChatMessages {
  ...
  ResponseChatMessages({required this.error, required this.messages, required this.unread});
...
class ChatMessages {
  ...
  ChatMessages({required this.id, required this.date, required this.text,
    required this.author, required this.delivered, required this.read});
