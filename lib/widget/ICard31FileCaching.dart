...
class ICard31FileCaching extends StatefulWidget {
  ...
  ICard31FileCaching({Key? key, this.id = 0, this.colorRight = Colors.grey, this.text = "", this.textStyle = const TextStyle(),
    this.balloonColor = Colors.black, this.date = "", this.dateStyle = const TextStyle(), this.colorLeft = Colors.white12,
