...
copyrightBlock(Function(String) callback){
  ...
  if (appSettings.about == "true" && appSettings.aboutTextName.isNotEmpty)
    list.add(copyrightItem(appSettings.aboutTextName, 20, callback));
  if (appSettings.delivery == "true" && appSettings.deliveryTextName.isNotEmpty)
    list.add(copyrightItem(appSettings.deliveryTextName, 21, callback));
  if (appSettings.privacy == "true" && appSettings.privacyTextName.isNotEmpty)
    list.add(copyrightItem(appSettings.privacyTextName, 22, callback));
  if (appSettings.terms == "true" && appSettings.termsTextName.isNotEmpty)
    list.add(copyrightItem(appSettings.termsTextName, 23, callback));
  if (appSettings.refund == "true" && appSettings.refundTextName.isNotEmpty)
    list.add(copyrightItem(appSettings.refundTextName, 24, callback));

  list.add(SizedBox(height: 10,));
  if (appSettings.copyright == "true" && appSettings.copyrightText.isNotEmpty)
