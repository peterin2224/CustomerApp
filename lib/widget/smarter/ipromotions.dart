...
class IPromotionSmart extends StatefulWidget {
  ...
  final int seconds;
  IPromotionSmart(this.dataPromotion, {this.width = 100, this.height = 100,
    this.colorGrey = const Color.fromARGB(255, 180, 180, 180), required this.colorActivy, required this.style,
    this.callback, this.seconds = 3, this.colorProgressBar = Colors.black,
