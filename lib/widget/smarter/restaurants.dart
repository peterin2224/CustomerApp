...
sHorizontalTopRestaurants(List<Widget> listOutput, Function() openFilter, int distanceForNearYourFilter, double windowWidth,
  ...
  for (var item in nearYourRestaurants) {
    ...
    list.add(ICard20FileCachingSmart(
      ...
      id: item.id,
      titleStyle: theme.text18boldPrimaryUI,
      bodyStyle: theme.text16UI,
      callback: _onRestaurantClick,
...
class ICard20FileCachingSmart extends StatefulWidget {
  ...
  ICard20FileCachingSmart({this.color = Colors.white, this.width = 100, this.height = 100, this.colorProgressBar = Colors.black,
    ...
    this.id = "", this.titleStyle = const TextStyle(), this.bodyStyle = const TextStyle(), this.callback, this.callbackNavigateIcon,
    this.text3 = "", required this.direction,
    this.radius = 0, this.shadow = 0,
  });
                ...
                InkWell(
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(widget.text, style: widget.titleStyle, overflow: TextOverflow.ellipsis,),
                            Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                  Expanded(child: Text(widget.text2, maxLines: 1, style: widget.bodyStyle, overflow: TextOverflow.ellipsis,)),
                                  Text(widget.text3, style: widget.bodyStyle, overflow: TextOverflow.ellipsis, textAlign: TextAlign.end,),
                              ],
                            ),
                          ],
                        ))),
