...
class ICard20FileCaching extends StatefulWidget {
  ...
  ICard20FileCaching({this.color = Colors.white, this.width = 100, this.height = 100, this.colorProgressBar = Colors.black,
    ...
    this.id = "", this.title = const TextStyle(), this.body = const TextStyle(), this.callback, this.callbackNavigateIcon,
    this.text3 = "", this.direction = TextDirection.ltr,
                      ...
                      child: Container(
                        padding: EdgeInsets.only(left: 5, right: 5),
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text(widget.text, style: widget.title, overflow: TextOverflow.ellipsis,),
                              Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                Container(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                   children: [
                                    Text(widget.text2, maxLines: 1, style: widget.body, overflow: TextOverflow.ellipsis,),
                                    Text(widget.text3, style: widget.body, overflow: TextOverflow.ellipsis,),
                                  ],)),
                                  Container(
                                      height: 30,
                                      width: 30,
