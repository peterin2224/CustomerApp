...
class IList6 extends StatefulWidget {
  ...
  IList6({this.initState = true, this.leading, this.title = "", this.subtitle = "",
    this.text = "", this.textStyle = const TextStyle(), this.titleStyle = const TextStyle(),
    this.subtitleStyle = const TextStyle(), this.id = "",
    this.callback
  });
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
        ...
        child: ListTile(
            ...
            subtitle: (widget.subtitle.isNotEmpty) ? Text(widget.subtitle, style: widget.subtitleStyle) : null,
            trailing: Container(
