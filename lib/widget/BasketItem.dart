...
class BasketItem extends StatefulWidget {
  ...
  BasketItem({this.color = Colors.grey, this.price = "", this.title1 = "",
    this.press, required this.id, this.count = 1, this.colorBorder = Colors.white,
    required this.getCount, this.delete,
    required this.image, this.width = 100, this.heroTag, this.incDec, this.height = 120,
    });
