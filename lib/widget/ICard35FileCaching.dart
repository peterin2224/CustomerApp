...
class ICard35FileCaching extends StatefulWidget {
  ...
  ICard35FileCaching({Key? key, this.id = "", this.color = Colors.grey, this.text = "",
    this.textStyle = const TextStyle(), this.title = "",
    this.titleStyle = const TextStyle(),  this.colorProgressBar = Colors.black, this.type = "",
    this.balloonColor = Colors.black, this.work = "", this.callback,
    this.callbackDelete, this.selected = false,
  }) : super(key: key);
