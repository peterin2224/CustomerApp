...
class ICard29FileCaching extends StatefulWidget {
  ...
  ICard29FileCaching({Key? key, this.id = "", this.color = Colors.grey, this.text = "",
    this.textStyle = const TextStyle(), this.title = "", this.titleStyle = const TextStyle(),  this.colorProgressBar = Colors.black,
    this.userAvatar = "", this.balloonColor = Colors.black,
    this.callback, this.date = "", this.dateStyle = const TextStyle()
  }) : super(key: key);
