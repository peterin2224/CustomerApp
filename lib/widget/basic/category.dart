...
bCategoryDetails(List<Widget> list, double windowWidth, Function (String id, String heroId) callback, Function(String) _onAddToCartClick){
...
categoryDetailsHorizontal(String categoryId, double windowWidth, Function (String id, String heroId) callback,
    Function(String) _onAddToCartClick){
  List<Widget> list = [];
