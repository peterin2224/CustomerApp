...
class ICard12FileCaching extends StatefulWidget {
  ...
  ICard12FileCaching({this.color = Colors.white, this.width = 100, this.height = 100,
    ...
    this.id = "", this.textStyle = const TextStyle(), this.callback,
              ...
              tag: _id,
                ...
                child: Container(
                  ...
                  child: FittedBox(
                      ...
                      child: Text(widget.text, style: widget.textStyle, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, maxLines: 2,)),
