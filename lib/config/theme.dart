...
class AppThemeData{
  ...
  late TextStyle text12Ubold;
  late TextStyle text10white;
  late TextStyle text14;
  late TextStyle text14R;
  late TextStyle text14l;
  ...
  late TextStyle text16Red;
  late TextStyle text16UI;
  late TextStyle text16Ubold;
  late TextStyle text16UIWhite;
  late TextStyle text16Companyon;
  late TextStyle text16bold;
  late TextStyle text16boldWhite;
  late TextStyle text18boldPrimary;
  late TextStyle text18boldPrimaryUI;
  late TextStyle text18boldPrimaryUIWhite;
